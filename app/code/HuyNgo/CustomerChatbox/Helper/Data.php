...
namespace HuyNgo\CustomerChatbox\Helper;

class Data extends \Magento\Framework\App\Helper\AbstractHelper
{
    const FACEBOOK_MESSENGER_ENABLE = 'huyngo_customer_chatbox/general/facebook_messenger_enable';
    const FACEBOOK_MESSENGER_CUSTOMER_CHAT_CODE = 'huyngo_customer_chatbox/general/facebook_messenger_customer_chat_code';
    const TAWK_TO_WIDGET_ENABLE = 'huyngo_customer_chatbox/general/tawk_enable';
    const TAWK_TO_WIDGET_CODE = 'huyngo_customer_chatbox/general/tawk_widget_code';
